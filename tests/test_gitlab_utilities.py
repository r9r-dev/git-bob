...
def test_get_gitlab_issue():
    ...
    assert "the world looks good" in get_issue_details("r9r-dev/git-bob", 1)
...
def test_get_conversation_on_issue():
    ...
    conversation = get_conversation_on_issue("r9r-dev/git-bob", 1)
...
def test_get_most_recent_comment_on_issue():
    ...
    user, comment = get_most_recent_comment_on_issue("r9r-dev/git-bob", 12)
...
def test_list_repository_files():
    ...
    files = list(list_repository_files("r9r-dev/git-bob", branch_name="main"))
