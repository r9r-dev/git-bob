...
def setup_ai_remark():
    ...
    return f"<sup>This message was generated by {agent_name}](https://github.com/r9r-dev/git-bob) (version: {__version__}, model: {model}{link}), an experimental AI-based assistant. It can make mistakes and has [limitations](https://github.com/r9r-dev/git-bob?tab=readme-ov-file#limitations). Check its messages carefully. {remarks}</sup>"
